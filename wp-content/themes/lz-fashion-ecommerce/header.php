					...
					<div class="col-lg-6 col-md-6 p-0">
						<div class="top">
							<?php if( get_theme_mod( 'lz_fashion_ecommerce_call','' ) != '') { ?>
						        <a href="tel:<?php echo esc_attr( get_theme_mod('lz_fashion_ecommerce_call','') ); ?>"><i class="fas fa-phone"></i><span class="col-org"><?php echo esc_html( get_theme_mod('lz_fashion_ecommerce_call','') ); ?></span></a>
						    <?php } ?>		
						    <?php if( get_theme_mod( 'lz_fashion_ecommerce_mail','' ) != '') { ?>
						        <a href="mailto:<?php echo esc_attr( get_theme_mod('lz_fashion_ecommerce_mail','') ); ?>"><i class="fas fa-envelope"></i><span class="col-org"><?php echo esc_html( get_theme_mod('lz_fashion_ecommerce_mail','') ); ?></span></a>
						    <?php } ?>		   		
						</div>	
					</div>
					<div class="col-lg-6 col-md-6 p-0">
						<?php if (has_nav_menu('woocommerce-menu')){ ?>
				      	...
				      	<div class="col-lg-9 col-md-7">
				      		<?php if (has_nav_menu('responsive')){ ?>
					      		<div class="toggle-menu responsive-menu">
							        <button onclick="lz_fashion_ecommerce_open()" role="tab" class="mobile-menu"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','lz-fashion-ecommerce'); ?></span></button>
							    </div>
