...
function lz_fashion_ecommerce_setup() {
	...
	global $pagenow;
		...
		add_action( 'admin_notices', 'lz_fashion_ecommerce_activation_notice' );
	}
...
function lz_fashion_ecommerce_activation_notice() {
	echo '<div class="notice notice-success is-dismissible start-notice">';
		echo '<h3>'. esc_html__( 'Welcome to Luzuk!!', 'lz-fashion-ecommerce' ) .'</h3>';
		echo '<p>'. esc_html__( 'Thank you for choosing LZ Fashion Ecommerce theme. It will be our pleasure to have you on our Welcome page to serve you better.', 'lz-fashion-ecommerce' ) .'</p>';
		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=lz_fashion_ecommerce_guide' ) ) .'" class="button button-primary">'. esc_html__( 'GET STARTED', 'lz-fashion-ecommerce' ) .'</a></p>';
	echo '</div>';
}
...
//footer Link
define('LZ_FASHION_ECOMMERCE_LIVE_DEMO',__('https://luzukdemo.com/demo/lz-fashion-ecommerce/','lz-fashion-ecommerce'));
define('LZ_FASHION_ECOMMERCE_PRO_DOCS',__('https://luzukdemo.com/demo/lz-fashion-ecommerce/documentation/','lz-fashion-ecommerce'));
define('LZ_FASHION_ECOMMERCE_BUY_NOW',__('https://www.luzuk.com/product/fashion-wordpress-theme/','lz-fashion-ecommerce'));
define('LZ_FASHION_ECOMMERCE_SUPPORT',__('https://wordpress.org/support/theme/lz-fashion-ecommerce/','lz-fashion-ecommerce'));
