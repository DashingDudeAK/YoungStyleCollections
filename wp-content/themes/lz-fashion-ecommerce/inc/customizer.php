...
final class LZ_Fashion_Ecommerce_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->add_section(
			new LZ_Fashion_Ecommerce_Customize_Section_Pro(
				$manager,
				'lz_fashion_ecommerce_example_1',
				array(
					'priority' => 9,
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'lz-fashion-ecommerce-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/assets/js/customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'lz-fashion-ecommerce-customize-controls', trailingslashit( esc_url(get_template_directory_uri()) ) . '/assets/css/customize-controls.css' );
	}
}
